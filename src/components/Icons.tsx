...
// Service icon map by service id
export const SERVICE_ICONS: Record<string, () => React.ReactElement> = {
  "iphone-screen-repair": Icons.Phone,
  "samsung-screen-repair": Icons.Samsung,
  "ipad-screen-repair": Icons.Tablet,
  "battery-replacement": Icons.Battery,
  "charging-port-repair": Icons.Plug,
  "back-glass-repair": Icons.Glass,
  "game-console-hdmi-repair": Icons.Gamepad,
  "water-damage-repair": Icons.Water,
  "diagnostic-no-power": Icons.Search,
  "laptop-repair": Icons.Laptop,
  "computer-repair": Icons.Monitor,
};
