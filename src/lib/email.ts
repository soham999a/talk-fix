    ...
    html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
      ...
      <div style="background:white;padding:24px;border:1px solid #eee;border-radius:0 0 8px 8px">
        ...
        <div style="background:#fff3f3;border-left:4px solid #bc0100;padding:16px;margin-top:16px;border-radius:4px">
          <strong style="color:#bc0100">Video Link:</strong><br/>
          <a href="${data.videoLink}" style="color:#bc0100;font-weight:bold">${data.videoLink}</a>
        </div>
      </div>
      <p style="color:#aaa;font-size:11px;text-align:center;margin-top:12px">Talk N Fix Wireless · Powered by NiceCare</p>
    </div>`,
  });
